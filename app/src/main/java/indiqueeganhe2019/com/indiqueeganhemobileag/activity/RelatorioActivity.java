...
public class RelatorioActivity extends AppCompatActivity {
    ...
    private DatabaseReference relatorioRef;

    private AlertDialog dialog;
    private String filtroEstado= "";
    private String filtroCategoria= "";
    private Boolean filtranPorEstado = false;
    private DatabaseReference anunciosPublicosRef;//AQUI NO CASO É RELATORIOS REF
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("clique para alterar status");
        ...
        relatorioRef= ConfiguracaoFirebase.getFirebase().child("relatorio")
                .child(ConfiguracaoFirebase.getIdUsuario());


        //config recycler
        recyclerRelatorio.setLayoutManager(new LinearLayoutManager(this));
        recyclerRelatorio.setHasFixedSize(true);
        adapterAnuncios= new AdapterAnuncios(listaAnuncios,this);
        recyclerRelatorio.setAdapter(adapterAnuncios);

        recuperarRelatorio();
        //aplicar evento de clique
        recyclerRelatorio.addOnItemTouchListener(
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Intent i = new Intent(RelatorioActivity.this,DetalhesRelatorioActivity.class);
    ...
    public void recuperarRelatorio(){
        ...
        listaAnuncios.clear();
        relatorioRef.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    //////AQUI VOU CONFIGURAR OS FILTROS
